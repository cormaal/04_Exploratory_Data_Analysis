...
pollution_2008 <- fread("./data/daily_88101_2008.csv", select = c(26, 17, 25), col.names = c("county", "PM2.5", "state"))
pollution_2009 <- fread("./data/daily_88101_2009.csv", select = c(26, 17, 25), col.names = c("county", "PM2.5", "state"))
pollution_2010 <- fread("./data/daily_88101_2010.csv", select = c(26, 17, 25), col.names = c("county", "PM2.5", "state"))
pollution <- rbind(pollution_2008, pollution_2009, pollution_2010)

states <- pollution$state
